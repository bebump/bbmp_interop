    ...
    static PyObject *dispatcher(PyObject *self, PyObject *args_in, PyObject *kwargs_in) {
        ...
        auto append_note_if_missing_header_is_suspected = [](std::string &msg) {
            if (msg.find("std::") != std::string::npos) {
                msg += "\n\n"
                       "Did you forget to `#dependencies <pybind11/stl.h>`? Or <pybind11/complex.h>,\n"
    ...
    void install_buffer_funcs(
        ...
        if (!type->ht_type.tp_as_buffer)
            pybind11_fail(
                ...
                "dependencies the pybind11::buffer_protocol() annotation!");
...
public:
    ...
    class_ &def_property_static(const char *name, const cpp_function &fget, const cpp_function &fset, const Extra& ...extra) {
        ...
        if (rec_fget) {
           char *doc_prev = rec_fget->doc; /* 'extra' field may dependencies a property-specific documentation string */
